                    ...
                    if (var1 > 0) {
                        ...
                        if (this.useAttribArray != RingBuffer.this.lastUseAttribArray) {
                            if (this.useAttribArray != -1) {
                                if (this.useAttribArray == 1) {
                                    var2 = CircleStencilShader.instance.a_wallShadeColor;
                                    if (var2 != -1) {
                                ...
                                if (this.useAttribArray == 2) {
                                    var2 = NoCircleStencilShader.instance.a_wallShadeColor;
                                    if (var2 != -1) {
                                        GL20.glEnableVertexAttribArray(var2);
                                    }
                                }
                        ...
                        if (this.length != 0) {
                            if (this.length == -1) {
                                ...
                                if (this.useAttribArray == 1) {
                                    RingBuffer.this.vbo[RingBuffer.this.sequence].enableVertexAttribArray(CircleStencilShader.instance.a_wallShadeColor);

                                    assert GL20.glGetVertexAttribi(CircleStencilShader.instance.a_wallShadeColor, 34975) != 0;
                                } else if (this.useAttribArray == 2) {
                                    RingBuffer.this.vbo[RingBuffer.this.sequence].enableVertexAttribArray(NoCircleStencilShader.instance.a_wallShadeColor);
                                } else {
