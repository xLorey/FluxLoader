 ...
 * Date: 07.02.2024
 * Description: Triggered when the player is fully connected to the server.
 * <p>FluxLoader © 2024. All rights reserved.</p>
 */
public abstract class OnPlayerFullyConnected extends Event {
    /**
     * Getting the event name
     * @return name of the event being implemented
     */
    @Override
    public String getEventName() { return "onPlayerFullyConnected"; }
