 ...
 * Date: 10.02.2024
 * Description: Plugin management menu
 * <p>FluxLoader © 2024. All rights reserved.</p>
 */
public class PluginMenu extends Widget {
    /**
     ...
     */
    private final Map<String, Plugin> loadedPlugins = PluginRegistry.getLoadedClientPlugins();
    ...
    private void renderPluginsInfo() {
        ...
        if (selectedPluginId != null) {
            ...
            Texture icon = PluginRegistry.getPluginIconRegistry().get(metadata.getId());
            float iconSize = 256;
            float windowWidth = ImGui.getWindowWidth();
