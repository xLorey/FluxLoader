...
/**
 * Embedding in the Kick Command
 */
public class PatchKickCommand extends PatchFile{
    /**
     * Injector constructor
     */
    public PatchKickCommand() {
        super("commands/serverCommands/KickUserCommand.class");
    }
            ...
            while (targetInst != null) {
                if (targetInst instanceof MethodInsnNode methodCall) {
                    if (methodCall.owner.contains("UdpConnection") && methodCall.name.equals("forceDisconnect")) {
                        ...
                        playerGetter.add(new VarInsnNode(Opcodes.ALOAD, 4));
                        ...
                        invokeEvent.add(new LdcInsnNode("onPlayerKick"));
                        ...
                        invokeEvent.add(new VarInsnNode(Opcodes.ALOAD, 0));
                        invokeEvent.add(new FieldInsnNode(Opcodes.GETFIELD,
