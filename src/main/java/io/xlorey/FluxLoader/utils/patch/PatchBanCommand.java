...
/**
 * Embedding in the Ban Command
 */
public class PatchBanCommand extends PatchFile{
    /**
     * Injector constructor
     */
    public PatchBanCommand() {
        super("commands/serverCommands/BanUserCommand.class");
    }
            ...
            while (targetInst != null) {
                if (targetInst instanceof MethodInsnNode methodCall) {
                    if (methodCall.owner.contains("UdpConnection") && methodCall.name.equals("forceDisconnect")) {
                        ...
                        playerGetter.add(new VarInsnNode(Opcodes.ALOAD, 6));
